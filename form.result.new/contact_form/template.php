            ...
            if ($arResult["isFormImage"] == "Y") {
                ...
                <a href="<?= $arResult["FORM_IMAGE"]["URL"] ?>" target="_blank" alt="<?= GetMessage("FORM_ENLARGE") ?>">
                    <img src="<?= $arResult["FORM_IMAGE"]["URL"] ?>"
                        ...
                        <? else: echo $arResult["FORM_IMAGE"]["ATTR"];
                        endif; ?>
        ...
        <form name="<?= $arResult["WEB_FORM_NAME"] ?>" class="contact-form__form" action="<?= POST_FORM_ACTION_URI ?>"
            ...
            <div class="contact-form__form-inputs">
                ...
                foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion) {
                    ...
                    else if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'textarea') continue;
                        ...
                        <div class="input contact-form__input">
                            <label class="input__label" for="medicine_name">
                                ...
                                if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'text') {
                                    echo "<div class='input__notification'>Поле должно содержать не менее 3-х символов</div>";
                                } else if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'email') {
                                    echo "<div class='input__notification'>Неверный формат почты</div>";
                                } ?>
                            </label>
                        </div>
                    <? }
